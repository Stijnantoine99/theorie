...
class Placing: 
    ...
    def eensgezinswoningen(self, aantal_eensgezins, wijk1):
        ...
        while counter < aantal_eensgezins: 
            ...
            print(oud_coor)
            coordinaten_eensgezin[counter] = oud_coor
