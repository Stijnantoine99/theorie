...
class Move(): 
    ...
    def move_eensgezin(self, coordinaten_maison, coordinaten_bungalow, coordinaten_eensgezin, wijk1):
        ...
        # create given lists of house coordinates as self variables
        self.coordinaten_maison = coordinaten_maison
        self.coordinaten_bungalow = coordinaten_bungalow
        self.coordinaten_eensgezin = coordinaten_eensgezin

        # run the kosten class with the particular parameters
        price = Kosten(wijk1, 12, 5, 3)
        counter = 0 

        # set Temperature for simulated_annealing
        simulated_annealing = 8

        # continue simulated annealing untill temperature is 0
        for i in range(8):

            for coordinaten in coordinaten_eensgezin:
                
                # create empty lists for the ... and possible proceeds respectively
                lijst = []
                opbrengst = []

                # add the particular coordinate to the created list
                lijst.append(coordinaten)

                # copy coordinates list of all eengezins houses
                coordinates = coordinaten_eensgezin
            
                # create the total price of all houses with the given coordinates
                new = price.total(coordinaten_maison, coordinaten_bungalow, coordinates)
                begin = new
                
                # add the calulated total price to the possible proceeds list
                opbrengst.append(new)

                # create acceptance probabilities list
                acceptance_probabilties = []
                
                # print(random.randrange(0, 5))
                stap = random.randrange(0, simulated_annealing)
                
                # Linksboven
                linksboven = [(coordinaten[0] - stap), (coordinaten[1] - stap)]
                lijst.append(linksboven)
                ...
                acceptance_begin = begin/1000000
                acceptance = round(2 ** (acceptance_begin - acceptance_new)/simulated_annealing, 3)
                acceptance_probabilties.append(acceptance)

                stap = random.randrange(0, simulated_annealing)

                # Boven
                boven = [(coordinaten[0]), (coordinaten[1] - stap)]
                lijst.append(boven)
                ...
                # Rechtsboven
                rechtsboven = [(coordinaten[0] + stap), (coordinaten[1] - stap)]
                lijst.append(rechtsboven)
                ...
                # Rechts
                rechts = [(coordinaten[0] + stap), (coordinaten[1])]
                lijst.append(rechts)
                ...
                # Rechtsonder
                rechtsonder = [(coordinaten[0] + stap), (coordinaten[1] + stap)]
                lijst.append(rechtsonder)
                ...
                # Onder
                onder = [(coordinaten[0]), (coordinaten[1] + stap)]
                lijst.append(onder)
                ...
                # Linksonder
                linksonder = [(coordinaten[0] - stap), (coordinaten[1] + stap)]
                lijst.append(linksonder)
                ...
                # Links
                links = [(coordinaten[0] - stap), (coordinaten[1])]
                lijst.append(links)
                ...
                if hoogste == begin:
                    ...
                    if random_2 < 0.1:
                        index_2 = random.randrange(0,8)
                        best_coor = lijst[index_2]
